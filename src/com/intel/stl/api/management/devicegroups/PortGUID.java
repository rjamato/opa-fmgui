...
public class PortGUID extends NumberNode {
    private static final long serialVersionUID = 7617164755278219233L;
     ...
     * @param value
     */
    public PortGUID(long value) {
        super(XMLConstants.PORT_GUID, value);
    }
    ...
    @Override
    public PortGUID copy() {
        return new PortGUID(value);
    }
