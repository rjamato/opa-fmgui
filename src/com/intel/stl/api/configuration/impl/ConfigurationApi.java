...
public class ConfigurationApi implements IConfigurationApi {
    ...
    public void registerCertsAssistant(ICertsAssistant assistant) {
        if (certsAssistant == null) {
            ...
            throw new IllegalStateException("Certs Assistant " + certsAssistant
                    + "alreday exists");
        }
    }
    ...
    public boolean isHostConnectable(SubnetDescription subnet)
        ...
        try {
            ...
            try {
                ...
                ConfigurationException ce =
                        new ConfigurationException(
                                STL50012_SOCKET_CLOSE_FAILURE, e,
                                subnet.getName(),
                                StringUtils.getErrorMessage(e));
                log.error(StringUtils.getErrorMessage(ce), e);
                throw ce;
    ...
    public PMConfigBean getPMConfig(SubnetDescription subnet) {
        ...
        try {
            ...
            ConfigurationException ce =
                    getConfigException(STL50008_SUBNET_CONNECTION_ERROR, e,
                            subnet.getPrimaryFE(),
                            StringUtils.getErrorMessage(e));
            throw ce;
        } finally {
     ...
     * 
     * @see
     * com.intel.stl.api.configuration.IConfigurationApi#saveLoggingConfiguration
