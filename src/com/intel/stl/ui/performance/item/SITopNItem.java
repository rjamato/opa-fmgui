...
/**
 * Top N Signal Integrity Errors
 */
public class SITopNItem extends TopNItem {
     ...
     * @param maxDataPoints 
     */
    public SITopNItem(int maxDataPoints, int topN) {
        super(UILabels.STL10206_TOPN_SIGNAL_INTEGRITY.getDescription(topN),
