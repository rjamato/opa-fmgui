...
public class BWHistogramItem extends HistogramItem {
    ...
    public BWHistogramItem(int maxDataPoints) {
        super(STLConstants.K0045_BANDWIDTH_HISTOGRAM.getValue(), maxDataPoints);
    }
    ...
    protected void initDataProvider() {
        ...
        registerDataProvider(TreeNodeType.DEVICE_GROUP.name(), provider, observer);
        
        CombinedVFInfoProvider vfProvider = new CombinedVFInfoProvider();
        VFBWHistogramDataObserver vfObserver = new VFBWHistogramDataObserver(this);
        registerDataProvider(TreeNodeType.VIRTUAL_FABRIC.name(), vfProvider, vfObserver);
    }
