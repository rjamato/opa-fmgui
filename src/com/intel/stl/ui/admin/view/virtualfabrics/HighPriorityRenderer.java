 ...
 *
 *  File Name: HighPriorityRenderer.java
 *
...
public class HighPriorityRenderer extends CheckRenderer<HighPriority> {
    @Override
    protected HighPriority createAttr(boolean isSelected) {
