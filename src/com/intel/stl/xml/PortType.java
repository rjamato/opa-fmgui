 ...
 *
 *  Archive Log:    $Log$
 *  Archive Log:    Revision 1.2  2014/11/11 18:03:43  fernande
 ...
 *                   &lt;element name="Group" type="{}PortGroupType"/>
 *                 &lt;/sequence>
 *               &lt;/restriction>
 *             &lt;/complexContent>
 *           &lt;/complexType>
...
@XmlType(name = "PortType", propOrder = { "groups" })
@XmlRootElement(name = "PortType")
public class PortType extends ResourceClassType {

    // @XmlElement(name = "Group", required = true)
    @XmlElementWrapper(name = "Groups")
    @XmlElementRef(type = PortGroupType.class)
    protected List<GroupType> groups;

    /**
     * Gets the value of the groups property.
     * 
     * @return possible object is {@link PortType.Groups }
     * 
     */
     ...
     * 
     * @param value
     *            allowed object is {@link PortType.Groups }
     * 
     */
